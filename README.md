...
- Visible fetches `assets/dictionary.mobi` on first run and caches the parsed index in
  IndexedDB. Leave the file out and the reader just falls back to drag-and-drop.
